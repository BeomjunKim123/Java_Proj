...
public class ProblemBeforeGeneric {
	...
	public static void main(String[] args) {
		/*
		 	제네릭을 사용하기전의 여러 가지 문제점 : 
		 		- 제네릭은 클래스 내부에 다양한 타입을 사용자가 정의해서 넣을 수 있다.
		 		- 제네릭을 사용전에는 하나의 클래스에 다양한 타입의 정보를 저장하려면 각 각의 클래스를 만들어서 사용함.
		 		- 하나의 클래스에 다양한 객체정보를 저장하기 위해서 object 타입으로 업캐스팅해서 저장후 다시 다운캐스팅을 사용해서 객체 내부의
		 			정보를 읽고/쓰기를 했음
		 		- 제네릭을 사용하면 업캐스팅 / 다운캐스팅 없이 여러타입의 객체를 하나의 클래스에 넣고 사용
		 */
