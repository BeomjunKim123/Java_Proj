...
//인터페이스 : 제너릭 타입 제한시 인터페이스일때 다중 제한이 가능 하다. 클래스 일때는 하나만 처리할 수 있다.
...
class Aa implements IF1 {
	...
	class Aaa extends Aa {
		@Override
		public void print() {
			System.out.println("Aaa 구현된 메소드 호출");
			
		}
		
		public void print2() {
			System.out.println("Aa의 잦식 Aaa의 print2 메소드");
		}
	}
...
class E <T extends IF1 & IF2 & IF3> { // T : IF1 (자식 : Aa, Aaa),
	...
	public static void main(String[] args) {
		/*
		 	제너릭 메소드에서 타입 제한 :
		 		...
		 		- 타입을 제한을 두면 : 제한을 둔 클래스의 메소드를 사용 가능
		 */
