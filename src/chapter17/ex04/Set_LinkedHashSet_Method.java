...
public class Set_LinkedHashSet_Method {
	...
	public static void main(String[] args) {
		...
		System.out.println(hSet2.toString()); //켈렉션의 모든 구현체는 toString()이 재정의
		...
		//8. itarator 를 사용해서 set에 저장된 값을 출력 : <== set은 방번호가 없어서 for문을 사용해서 값을 가자올 수 없다.
		...
		//8-1. Iterator 객체를 사용해서 hSet3에 저장된 값을 가지고 옴
