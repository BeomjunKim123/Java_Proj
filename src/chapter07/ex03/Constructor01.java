...
class Student {
	...
	// 생성자 오버로딩 : 생성자 이름은 동일하고, 아규먼트로 받는 매개변수의 개수, 매개변수의 차이
...
public class Constructor01 {
	public static void main(String[] args) {
		...
		Student s6 = new Student("을지문덕", "함경북도", "ccc@ccc.com", 40, 70);
		
		//각 객체의 필드의 지정된 값을 출력 (toString())
