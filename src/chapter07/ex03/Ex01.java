...
class Product {
	...
	@Override
	public String toString() {
		return "Product [proName=" + proName + ", proNo=" + proNo + ", ProPrice=" + proPrice + 
				", proCount=" + proCount + "]";
				*/
}
...
public class Ex01 {
	...
	public static void main(String[] args) {
		...
		Product p2 = new Product("제품번호 : lh1"); 
		Product p3 = new Product("제품가격 : 50만원"); 
		Product p4 = new Product("제품수량 : 2개"); 
