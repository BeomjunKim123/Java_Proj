...
public class Method04 {
	...
	public static void main(String[] args) {
		...
		System.out.println(s1 + s2); //String + String
		System.out.println(Integer.parseInt(s1) + Integer.parseInt(s2)); //180
		...
		//sum (10, 10); //인스턴스 메소드 : 객체 생성후 호출
			sum2(10, 10); //정적(static) 메소드 : 객체 생성후 호출, 클래스명으로 호출, 메소드명으로 바로 호출
