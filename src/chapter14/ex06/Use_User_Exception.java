...
//100점 이상을 갚으면 예외를 강제로 발생 시킴 : 일반 예외
...
class Aa {
	...
	void checkScore (int score) throws OverException, MinusException {
		if ( score < 0 ) {
			//MinusException 호출
			...
			//OverException 호출
			throw new OverException("예외 발생됨 : 100점 이상은 입력 불가");
...
////		Aa a1 = new Aa();
////		
////		//메소드 호출 : trows 미루었기 때문에 호출하는 쪾에서 예외를 처리
////		
////		try {
////			
////			a1.checkScore(110);
////		} catch (OverException |  MinusException) {
////			// e.printStackTrace();
