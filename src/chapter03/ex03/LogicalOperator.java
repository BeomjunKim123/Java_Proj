...
public class LogicalOperator {
	public static void main(String[] args) {
		...
		System.out.println("==============================");
		// ^ : KOR : 앞뒤의 값이 같을때 false (0), 앞 뒤의 값이 다를때 true (1)
		...
		// (중요)쇼트 서킷이 발생 될 수 있다.
			// -- 논리 연산에서 앞의 값으로 결과값을 유추 할 수 있는 경우 뒤의 내용을 무시해서 처리하지 않는다.
		
		// && 연산에서 false 가 오면 뒤에는 어떤 값이 와도 false
		System.out.println(true && true); //쇼트 서킷이 발생 되지 않는다.
		System.out.println(false && true); //쇼트 서킷이 발생 된다. 앞의 값이 false 이면 뒤에값은 화인하지 않아도 false 이다.
		
		System.out.println("==============================");
		//예제 : AND 연산에서 쇼트 서킷이 발생되는 예제
		int val1 = 3;
		System.out.println(false && ++val1 > 6); // false인데 뒤에 값을 확인 안함 : &&
		...
		System.out.println("==============================");
		// 쇼트 서킷을 방지하기 위한 방안 : 비트 연산자를 사용한다. &, | <== 쇼트 서킷을 발생시키지 않는 연산자
		//예제 : AND 연산에서 쇼트 서킷이 발생되는 예제
		int val2 = 3;
