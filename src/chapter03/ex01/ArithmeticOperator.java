...
public class ArithmeticOperator {
	public static void main(String[] args) {
		...
		//2. 증감 연산자 :  ++, --
			...
			int val3 = 3;
			int val4 = val3++; //앞에는 연산을 넣고 나오고 뒤에 연산이 있으면 출력하고 나중에 연산
