...
abstract class Animal {
	...
	//구현부가 없어 선언만 된 메소드 : 추상 메소드 <== 자식클래스에서 오버라이딩해서 구현부를 만들어 줘야한다.
	abstract void eat();
	abstract void run();
	abstract void cry();
...
public class Abstract_Method02 {
	...
	public static void main(String[] args) {
		...
		//Animal a3 = new Lion(); //Lion은 추상 클래스 이믜로 객체화 할수 없다.
